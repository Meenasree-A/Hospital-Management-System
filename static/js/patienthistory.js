$(document).ready(function () {
    ...
    function addPatienthistory(data) {
        ...
        $.ajax(settings).done(function (response) {
           $.notify("Issue Added Successfully", {"status":"success"});
    ...
    function deletePatienthistory(id) {
        ...
        swal({
           ...
           $.ajax(settings).done(function (response) {
             swal("Deleted!", "Patient history has been deleted.", "success");
             table.destroy();
            $('#datatable4 tbody').empty(); // empty in case the columns change
            getPatienthistory()
        });
    ...
    function getPatienthistory() {
        ...
        $.ajax(settings).done(function (response) {
            ...
            $('#datatable4 tbody').on('click', '.delete-btn', function () {
                ...
                console.log(data)
                deletePatienthistory(data.Patient_Patient_ID)
    ...
    $("#addPatienthistory").click(function () {
